...
gi = Company.create(id: 1, name: 'General International')
  alec = gi.merchants.create(id: 1, name: 'Alec Fitzgerald', company_id: 1)
...
es = Company.create(id: 2, name: 'Electronics Surplus')
  ursula = es.merchants.create(id: 2, name: 'Ursula Charlton', company_id: 2)
